...
/**
 * @minions-documents/cli — CLI for Minions documents
 *
...
import { customTypes } from '@minions-documents/sdk';
...
program.name('documents').description('Versioned text documents, templates, and file attachments').version('0.1.0');

program.command('info').description('Show project info').action(() => {
    console.log(chalk.bold('Minions documents'));
    console.log(chalk.dim('Versioned text documents, templates, and file attachments'));
    console.log('');
    console.log(`  SDK:    ${chalk.cyan('@minions-documents/sdk')}`);
    console.log(`  CLI:    ${chalk.cyan('@minions-documents/cli')}`);
    console.log(`  Python: ${chalk.cyan('minions_documents')}`);
