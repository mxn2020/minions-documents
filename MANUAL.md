# Manual Setup Steps for Minions Documents
...
Go to **GitHub → mxn2020/minions-documents → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-documents` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-documents-web`
- **GitHub repo**: `mxn2020/minions-documents`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `documents.minions.wtf`

### Documentation
- **Netlify site name**: `minions-documents-docs`
- **GitHub repo**: `mxn2020/minions-documents`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `documents.minions.help`

### Blog
- **Netlify site name**: `minions-documents-blog`
- **GitHub repo**: `mxn2020/minions-documents`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `documents.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `documents.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `documents.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `documents.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-documents/sdk`](https://www.npmjs.com/package/@minions-documents/sdk)
- CLI: [`@minions-documents/cli`](https://www.npmjs.com/package/@minions-documents/cli)
...
Your package: [`minions-documents`](https://pypi.org/project/minions-documents/)
...
| Item | Value |
|------|-------|
| Project | `minions-documents` |
| SDK (npm) | `@minions-documents/sdk` |
| CLI (npm) | `@minions-documents/cli` |
| Python (PyPI) | `minions-documents` |
| GitHub | `github.com/mxn2020/minions-documents` |
| Docs domain | `documents.minions.help` |
| Blog domain | `documents.minions.blog` |
| App domain | `documents.minions.wtf` |
